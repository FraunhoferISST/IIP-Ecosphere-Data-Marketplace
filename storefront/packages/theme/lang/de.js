...
export default {
  ...
  'Delivery method': 'Auslieferungsmethode  ',
  'Apply': 'Übernehmen',
  ...
  'Order No.': 'Bestellung-Refereznummer',
  'Successful placed order': 'Sie haben die Bestellung erfolgreich aufgegeben. Sie können den Status Ihrer Bestellung Sie in Ihrem Account unter "Meine Bestellungen" verfolgen . Sie erhalten eine Bestellung Bestätigungs-E-Mail mit Details Ihrer Bestellung. Bitte bezahlen Sie die Bestellung so schnell wie möglich per Überweisung und markieren Sie die Bestellung als bezahlt',
  'Info after order': 'Sie können sich mit E-Mail und definiertem Passwort in Ihrem Konto anmelden. Dort können Sie Ihre Profildaten bearbeiten und den Status Ihrer Transaktionen verfolgen.',
  ...
  'Manage billing addresses': 'Ihre Rechnungsadressen.',
  ...
  'Review order': 'Bestellungsübersicht',
  'or': 'oder',
  ...
  'Invoice': 'Rechnung',
  'Apply offer': 'Angebot vorschlagen',
  'Create your inquiry': 'Erstelle deine Anfrage',
  'Desired pricing': 'Gewünschtes Preismodel',
  'Update inquiry': 'Anfrage aktualisieren',
  'Data privacy and imprint': 'Datenschutz und Impressum',
