<template>
  ...
  <SfBottomNavigation class="navigation-bottom smartphone-only">
    ...
    />
    <SfBottomNavigationItem icon="search" size="20px" label="Discover" @click="handleDiscoverClick"/>
...
import { useUser, useCart, cartGetters } from "@vue-storefront/iiepmarket";
