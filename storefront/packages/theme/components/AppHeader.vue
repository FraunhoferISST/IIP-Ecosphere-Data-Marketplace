    ...
    >
      ...
      <template #logo>
        <nuxt-link :to="localePath({ name: 'home' })" class="">
          <SfImage :width="80" :src="addBasePath('/logos/iipe_logo.svg')" alt="Shop" class="sf-header__logo-image"/>
        </nuxt-link>
      </template>
      <template #navigation>
...
import { useCart, useUser, cartGetters } from "@vue-storefront/iiepmarket";
