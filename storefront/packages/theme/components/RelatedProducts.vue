...
import { productGetters, useWishlist, wishlistGetters, useCart } from "@vue-storefront/iiepmarket";
...
export default {
  ...
  setup() {
    ...
    const removeProductFromWishlist = (productItem) => {
      ...
      const product = productsInWhishlist.value.find(wishlistProduct => wishlistProduct === productItem);
